...
## 测试集大小为30%， 70%/30%分
x_train, x_test, y_train, y_test = train_test_split(data_features_part, data_target_part, test_size = 0.3)
...
bst.save_model('C:\\Users\\austl\Desktop\\baXgboost\\xunlian\\model1') # 保存实验模型
